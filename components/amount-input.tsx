        ...
        <Tooltip delayDuration={100}>
          <TooltipTrigger asChild>
            <button 
              ...
              className={cn(
                " bg-neutral-900 hover:bg-neutral-950 absolute top-1.5 left-1.5 rounded-md p-2 flex items-center justify-center transition ring-1 ring-neutral-900",
                isIncome && "bg-emerald-500 hover:bg-emerald-600",
                isExpense && "bg-rose-500 hover:bg-rose-600"
              )}
            >
              {!parsedValue && <Info className="size-3 text-violet-600" />}
